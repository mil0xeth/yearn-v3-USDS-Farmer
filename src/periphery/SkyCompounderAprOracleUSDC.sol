...
contract SkyCompounderAprOracleUSDC is AprOracleBase {
    constructor() AprOracleBase("SkyCompounder USDC APR Oracle", 0xFEB4acf3df3cDEA7399794D0869ef76A6EfAff52) {}
    ...
    function aprAfterDebtChange(
        ...
        totalSupply = uint256(int256(totalSupply) + _delta * int256(SCALER));
