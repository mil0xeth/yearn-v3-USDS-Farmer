...
import {CompounderSetupDAI} from "./utils/CompounderSetupDAI.sol";
import {Math} from "@openzeppelin/contracts/utils/math/Math.sol";
import {ERC20} from "@openzeppelin/contracts/token/ERC20/ERC20.sol";

contract CompounderOperationTestDAI is CompounderSetupDAI {
...
*/
    ...
    function test_emergencyWithdrawAll(uint256 _amount) public {
        ...
        assertGe(asset.balanceOf(address(strategy)) + 3, _amount + 100e18, "!all in asset");
